    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        <div className="text-sm text-gray-500 mb-4">
          <a href="/" className="hover:text-blue-600">Home</a> /{" "}
          <span className="text-gray-700">JPG to PNG</span>
        </div>

        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">JPG to PNG</h1>
        ...
        {file && (
          <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6">
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-lg px-4 py-2 mb-4 text-sm text-gray-600">
              Output Format: <span className="font-medium text-gray-800">PNG</span>
            </div>
              ...
              <div className="mt-6 border-t border-gray-100 pt-5">
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    <p className="text-sm font-medium text-gray-800">Converted to PNG</p>
