...
export default function JpgToWebpPage() {
  ...
  const downloadResult = () => {
    ...
    nameParts.pop();
    a.download = `${nameParts.join(".")}.webp`;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        <div className="text-sm text-gray-500 mb-4">
          <a href="/" className="hover:text-blue-600">Home</a> /{" "}
          <span className="text-gray-700">JPG to WebP</span>
        </div>

        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">JPG to WebP</h1>
        ...
        {!file && (
          ...
          >
            ...
            <p className="text-gray-700 font-medium text-center px-4">Drag &amp; Drop JPG Image Here</p>
            <p className="text-gray-400 text-sm mb-4">or</p>
            <button type="button" className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-5 py-2 rounded-lg">
              Choose JPG Image
            </button>
            <input ref={inputRef} type="file" accept="image/jpeg" className="hidden" onChange={onFileChange} />
          </div>
        )}
        ...
        {file && (
          <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6">
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-lg px-4 py-2 mb-4 text-sm text-gray-600">
              Output Format: <span className="font-medium text-gray-800">WebP</span>
            </div>
            ...
            <div className="mb-5">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <span className="text-sm text-gray-600 w-12 text-right">{quality}%</span>
              </div>
            </div>
              ...
              <div className="mt-6 border-t border-gray-100 pt-5">
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    <p className="text-sm font-medium text-gray-800">Converted to WebP</p>
